  ...
  return (
    <div>
      ...
      <PDFViewer style={{ width: "100%", height: "calc(100vh - 48px)" }}>
        <Document>
          <Page orientation="landscape" size={{ width: 780, height: 1480 }} style={styles.page}>
            <View style={styles.section}>
              <View style={styles.table}>
                ...
                <View style={styles.tableRow}>
                  <View style={{ ...styles.tableCell, flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <View style={{ flex: 1, marginLeft: 8 }}>
                      <Text style={styles.text2}>FORMATO REPORTE DE EFICIENCIA DE COMBUSTIÓN EN TEA</Text>
                      <Text style={styles.text2}>AGENCIA NACIONAL DE HIDROCARBUROS</Text>
                    </View>
                  </View>
                </View>
                {/*fila 1*/}
                ...
                <View style={{ ...styles.tableRow, backgroundColor: "rgb(242,242,242)" }}>
                  ...
                  <View style={styles.tableCell}><Text style={styles.text1}>Frecuencia de funcionamiento </Text></View>
                ...
                <View style={styles.tableRow}>
                  ...
                  <View style={styles.tableCell}><Text style={styles.text1}>{jsonData.TEAS[0].Ainstalacion}</Text></View>
                  <View style={styles.tableCell}><Text style={styles.text1}>{jsonData.TEAS[0].Ffun}</Text></View>
                ...
                {/*Titulo 2*/}
                <View style={{ ...styles.tableRow, backgroundColor: "rgb(180,198,231)" }}>
                  <View style={styles.tableCell}><Text style={{ textAlign: 'center' }}>SECCIÓN II. QUEMA DE GAS NATURAL EN EXPLORACIÓN DE HIDROCARBUROS</Text></View>
                </View>
                {/*Encabezados 2*/}
                <View style={{ ...styles.tableRow, backgroundColor: "rgb(242,242,242)" }}>
                  <View style={styles.tableCell}><Text style={styles.text1}>ID TEA</Text></View>
                  <View style={styles.tableCell}><Text style={styles.text1}>Volumen de gas quemado durante Operaciones de control de pozo (KPC/a) </Text></View>
                  <View style={styles.tableCell}><Text style={styles.text1}>Volumen de gas quemado durante pruebas iniciales para los pozos exploratorios y de avanzada (KPC/a)</Text></View>
                  <View style={styles.tableCell}><Text style={styles.text1}>Volumen de gas natural quemado durante Pruebas extensas </Text></View>
                </View>
                {/*contenido 2*/}
                <View style={styles.tableRow}>
                  <View style={styles.tableCell}><Text style={styles.text1}> {jsonData.TEAS[0].id}</Text></View>
                  <View style={styles.tableCell}><Text style={styles.text1}> {jsonData.TEAS[0].vgqocp}</Text></View>
                  <View style={styles.tableCell}><Text style={styles.text1}>{jsonData.TEAS[0].vgqpi}</Text></View>
                  <View style={styles.tableCell}><Text style={styles.text1}>{jsonData.TEAS[0].vgnqpe}</Text></View>
                </View>
                {/*contenido 2.1*/}
                <View style={styles.tableRow}>
                  <View style={styles.tableCell}><Text style={styles.text1}> </Text></View>
                ...
                {/*Titulo 3*/}
                <View style={{ ...styles.tableRow, backgroundColor: "rgb(180,198,231)" }}>
                  <View style={styles.tableCell}><Text style={styles.text2}>SECCIÓN III. QUEMA DE GAS NATURAL EN EXPLOTACIÓN DE HIDROCARBUROS</Text></View>
                </View>
                {/*Encabezados 3*/}
                <View style={{ ...styles.tableRow }}>
                  ...
                  <View style={{ ...styles.tableRow2, width: "30%" }}>
                    <View style={{ ...styles.tableCol, width: "100%" }}>
                      <View style={{ ...styles.tableCell2, borderBottom: "1px" }}><Text style={styles.text1} >Quema rutinaria</Text></View>
                      <View style={styles.tableCell2}>
                        <View style={{ ...styles.tableRow }}>
                          <View style={styles.tableCell}>
                            <View style={{ ...styles.tableCol, width: "100%" }}>
                              <View style={{ ...styles.tableCell2, borderBottom: "1px" }}><Text style={styles.text1}>Volumen de quema por seguridad</Text></View>
                              <View style={{ ...styles.tableRow }}>
                                <View style={{ ...styles.tableCell, border: "none", borderRight: "1px" }}><Text style={styles.text1}>Volumen de gas quemado por gas de purga (KPC/año)</Text></View>
                                <View style={{ ...styles.tableCell, border: "none" }}><Text style={styles.text1}> Volumen  de gas quemado por pilotos (KPC/año)</Text></View>
                              </View>
                            </View>
                          </View>
                          <View style={styles.tableCell}><Text style={styles.text1}> Volumen de gas quemado económinamente inviable</Text></View>

                        </View>
                      </View>
                    </View>
                  </View>
                  <View style={{ ...styles.tableRow2, width: "8%" }}><Text style={styles.text1}>Gas de venteo intencional recolectado para quema</Text></View>
                  <View style={{ ...styles.tableRow2, width: "8%" }}><Text style={styles.text1}>Quema por eventos planeados</Text></View>
                  <View style={{ ...styles.tableRow2, width: "38%" }}>
                    <View style={{ ...styles.tableCol, width: "100%" }}>
                      <View style={{ ...styles.tableCell2, borderBottom: "1px" }}><Text style={styles.text1} >Quema por eventos no planeados</Text></View>
                      <View style={{ ...styles.tableCell2 }}>
                        <View style={{ ...styles.tableRow }}>
                          <View style={{ ...styles.tableCell, border: "none", borderRight: "1px" }}><Text style={styles.text1}>Factor de eficiencia (Fe)</Text></View>
                          <View style={{ ...styles.tableCell, border: "none", borderRight: "1px" }}><Text style={styles.text1}>Factor de reducción de quema por eventos no planeados en el tiempo (Tr)</Text></View>
                          <View style={{ ...styles.tableCell, border: "none", borderRight: "1px" }}><Text style={styles.text1}>Factor F (Fe * Tr)</Text></View>
                          <View style={{ ...styles.tableCell, border: "none" }}><Text style={styles.text1}>Volumen de gas quemado por eventos no planeados (KPC/año)</Text></View>
                        </View>
                      </View>
                    </View>
                  </View>
                  <View style={{ ...styles.tableRow2, width: "8%" }}><Text style={styles.text1}>Quema por permiso puntual</Text></View>
                </View>
                {/*cONTENIDO 3*/}
                <View style={{ ...styles.tableRow }}>
                  <View style={{ ...styles.tableRow3, width: "8%" }}><Text style={styles.text1}> {jsonData.TEAS[0].id}</Text></View>
                  <View style={{ ...styles.tableRow3, width: "7.5%" }}><Text style={styles.text1}> {jsonData.TEAS[0].vgqgp}</Text></View>
                  <View style={{ ...styles.tableRow3, width: "7.5%" }}><Text style={styles.text1}> {jsonData.TEAS[0].vgqpp}</Text></View>
                  <View style={{ ...styles.tableRow3, width: "15%" }}><Text style={styles.text1}>{jsonData.TEAS[0].vgqev} </Text></View>
                  <View style={{ ...styles.tableRow3, width: "8%" }}><Text style={styles.text1}> {jsonData.TEAS[0].gvirc}</Text></View>
                  <View style={{ ...styles.tableRow3, width: "8%" }}><Text style={styles.text1}> {jsonData.TEAS[0].qpenp}</Text></View>
                  <View style={{ ...styles.tableRow3, width: "9.5%" }}><Text style={styles.text1}>{jsonData.TEAS[0].fe} </Text></View>
                  <View style={{ ...styles.tableRow3, width: "9.5%" }}><Text style={styles.text1}> {jsonData.TEAS[0].Tr}</Text></View>
                  <View style={{ ...styles.tableRow3, width: "9.5%" }}><Text style={styles.text1}>{jsonData.TEAS[0].FF} </Text></View>
                  <View style={{ ...styles.tableRow3, width: "9.5%" }}><Text style={styles.text1}>{jsonData.TEAS[0].vgqenp} </Text></View>
                  <View style={{ ...styles.tableRow3, width: "8%" }}><Text style={styles.text1}> {jsonData.TEAS[0].qppp}</Text></View>
                </View>
                {/*cONTENIDO 3.1*/}
                <View style={{ ...styles.tableRow }}>
                  ...
                  <View style={{ ...styles.tableRow3, width: "7.5%" }}><Text style={styles.text1}> </Text></View>
                  <View style={{ ...styles.tableRow3, width: "15%" }}><Text style={styles.text1}> </Text></View>
                  <View style={{ ...styles.tableRow3, width: "8%" }}><Text style={styles.text1}> </Text></View>
                  <View style={{ ...styles.tableRow3, width: "8%" }}><Text style={styles.text1}> </Text></View>
                  <View style={{ ...styles.tableRow3, width: "9.5%" }}><Text style={styles.text1}> </Text></View>
                  <View style={{ ...styles.tableRow3, width: "9.5%" }}><Text style={styles.text1}> </Text></View>
                  <View style={{ ...styles.tableRow3, width: "9.5%" }}><Text style={styles.text1}> </Text></View>
                  <View style={{ ...styles.tableRow3, width: "9.5%" }}><Text style={styles.text1}> </Text></View>
                  <View style={{ ...styles.tableRow3, width: "8%" }}><Text style={styles.text1}> </Text></View>
                ...
                {/*TITULO 4*/}
                <View style={{ ...styles.tableRow, backgroundColor: "rgb(180,198,231)" }}>
                  <View style={styles.tableCell}><Text style={{ textAlign: 'center' }}>SECCIÓN IV. RELACIÓN DE EMISIONES DE GASES DE EFECTO INVERNADERO</Text></View>
                </View>
                {/*Encabezado  4*/}
                <View style={{ ...styles.tableRow }}>
                  <View style={{ ...styles.tableRow2, width: "8%" }}><Text style={styles.text1}>ID TEA </Text></View>
                  ...
                  <View style={{ ...styles.tableRow2, width: "32%" }}>
                    <View style={{ ...styles.tableCol, width: "100%" }}>
                      ...
                      <View style={{ ...styles.tableRow }}>
                        <View style={{ ...styles.tableRow3, width: "12.5%" }}><Text style={styles.text1}>C1</Text></View>
                ...
                <View style={{ ...styles.tableRow, backgroundColor: "rgb(180,198,231)" }}>
                  <View style={styles.tableCell}><Text style={styles.text2}>SECCIÓN V. DOCUMENTOS ANEXOS AL FORMATO</Text></View>
                </View>
                <View style={styles.tableRow}>
                  <View style={styles.tableCell}><Text style={styles.text2}> </Text></View>
                </View>
                <View style={{ ...styles.tableRow, backgroundColor: "rgb(180,198,231)" }}>
                  <View style={styles.tableCell}><Text style={styles.text2}>SECCIÓN VI. OBSERVACIONES</Text></View>
                </View>
                <View style={styles.tableRow}>
                  <View style={styles.tableCell}><Text style={{ textAlign: 'center' }}> </Text></View>
                </View>
                <View style={{ ...styles.tableRow, backgroundColor: "rgb(180,198,231)" }}>
                  <View style={styles.tableCell}><Text style={styles.text2}>SECCIÓN VII. RESPONSABLES</Text></View>
                </View>
                <View style={styles.tableRow}>
