            ...
            <View style={styles.section}>
              <View style={styles.table}>
                ...
                <View style={{ ...styles.tableRow }}>
                  ...
                  >
                    <Text style={styles.text2}>ANH-COV-FR-20</Text>
                    <Text style={styles.text2}>30/10/2023</Text>
                    <Text style={styles.text2}>Versión 1</Text>
                  </View>
                </View>
                {/*fila 1*/}
                <View style={styles.tableRow}>
                ...
                >
                  ...
                  <View style={styles.tableCell}>
                    <Text style={styles.text1}>Tipo TEA</Text>
                  </View>
                  <View style={styles.tableCell}>
                    <Text style={styles.text1}>Presión del sistema (psig)</Text>
                  </View>
                  <View style={styles.tableCell}>
                ...
                <View style={styles.tableRow}>
                  ...
                  <View style={styles.tableCell}>
                    <Text style={styles.text1}>2014</Text>
                  </View>
                  <View style={styles.tableCell}>
                ...
                >
                  <View style={styles.tableCell}>
                    <Text style={styles.text2}>
                      SECCIÓN II. QUEMA DE GAS NATURAL EN EXPLOTACIÓN DE
                      HIDROCARBUROS
                    </Text>
                  </View>
                </View>
                ...
                <View style={{ ...styles.tableRow }}>
                  ...
                  >
                    <Text style={{ ...styles.text1, fontSize: "1vw" }}>
                      ID TEA{" "}
                    </Text>
                  </View>
                      ...
                      <View style={styles.tableCell2}>
                        <View style={{ ...styles.tableRow }}>
                          ...
                          <View style={{ ...styles.tableCell, border: "none" }}>
                            <Text
                              style={{ ...styles.text1, fontSize: "0.7vw" }}
                            >
                              {" "}
                              Volumen de gas quemado económinamente
                              inviable(KPC/año)
                            </Text>
                          </View>
                        </View>
                  ...
                  <View style={{ ...styles.tableRow2, width: "15%" }}>
                    <View
                      style={{
                        ...styles.tableCol,
                        width: "100%",
                    ...
                    >
                      ...
                      >
                        <Text style={{ ...styles.text1, fontSize: "0.7vw" }}>
                          Volumen de gas recolectado de venteo intencional y
                          quemado en TEA (KPC/año)
                        </Text>
                      </View>
                    </View>
                  </View>
                  <View style={{ ...styles.tableRow2, width: "15%" }}>
                    <View style={{ ...styles.tableCol, width: "100%" }}>
                      ...
                      >
                        <Text style={styles.text1}>
                          Volumen de gas quemado por eventos planeados (KPC/año)
                        </Text>
                      </View>
                    </View>
                  </View>
                  ...
                  <View style={{ ...styles.tableRow2, width: "10%" }}>
                    <View style={{ ...styles.tableCol, width: "100%" }}>
                      <View
                        style={{
                          ...styles.tableCell2,
                      ...
                      >
                        <Text style={styles.text1}>
                          Volumen de gas quemado por permisio puntual (KPC/año)
                        </Text>
                      </View>
                    </View>
                  </View>
                ...
                >
                  <View style={styles.tableCell}>
                    <Text style={{ textAlign: "center" }}>
                      SECCIÓN III. RELACIÓN DE EMISIONES DE GASES DE EFECTO
                      INVERNADERO
                    </Text>
                  </View>
                </View>
              ...
              >
                <View style={styles.tableCell}>
                  <Text style={styles.text2}>SECCIÓN V. OBSERVACIONES</Text>
                </View>
              </View>
              <View style={styles.tableRow}>
                <View style={styles.tableCell}>
              ...
              >
                <View style={styles.tableCell}>
                  <Text style={styles.text2}>SECCIÓN VI. RESPONSABLES</Text>
                </View>
              </View>
              <View style={styles.tableRow}>
                <View style={styles.tableCell}>
